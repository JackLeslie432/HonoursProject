...
void Camera::setMoveSpeed(float horizontal, float vertical)
{
...
void Camera::moveForward()
{
	...
	speed = frameTime * horizontalspeed;
...
void Camera::moveBackward()
{
	...
	speed = frameTime * horizontalspeed;// *0.5f;
...
void Camera::moveUpward()
{
	...
	speed = frameTime * verticalspeed;// *0.5f;
